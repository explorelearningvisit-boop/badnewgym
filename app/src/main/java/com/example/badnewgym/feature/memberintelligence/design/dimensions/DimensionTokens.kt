...
data class BADGymDimensions(
    ...
    val innerCardRadius: Dp = 14.dp,
    val pillRadius: Dp = 14.dp,
    val ctaRadius: Dp = 14.dp,
    val smallIconCornerRadius: Dp = 10.dp,
    val railWidth: Dp = 46.dp,
    val portraitWidth: Dp = 88.dp,
    val portraitHeight: Dp = 100.dp,
    ...
    val metricTileHeight: Dp = 94.dp,
    val metricProgressRingSize: Dp = 38.dp,
    val ctaHeight: Dp = 48.dp,
    val outerPadding: Dp = 8.dp,
    val outerPaddingHorizontal: Dp = 3.dp,
    val outerPaddingVertical: Dp = 4.dp,
