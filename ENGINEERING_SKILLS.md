...
\n\n## P. Collaboration and autonomous-session hygiene\n- context caching and invalidation\n- incremental repository inspection\n- state-machine thinking\n- idempotent task execution\n- checkpoint/resume design\n- conflict detection and reconciliation\n- evidence provenance\n- model handoff and multi-model review\n- change-impact analysis\n- token/time optimization without correctness loss\n\n## Q. Advanced product/UI craft\n- behavioral UX and cognitive load\n- glanceable operational dashboards\n- semantic motion systems\n- animation choreography and interruption safety\n- spatial/3D interface composition\n- material/lighting systems\n- responsive/adaptive composition\n- visual regression methodology\n- design-token architecture\n- component state matrices\n- edge-state design\n- perceptual hierarchy\n